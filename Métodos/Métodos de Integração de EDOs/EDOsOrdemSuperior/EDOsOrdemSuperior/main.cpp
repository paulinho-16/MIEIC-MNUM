...
void Metodo_EDO_Superior(double a, double A, double h)
{
...
int main()
{
	...
	Metodo_EDO_Superior(0, 0.4999, 0.025);
	cout << "\n----------\n";
	Sy = sy;
	Sz = sz;
	Metodo_EDO_Superior(0, 0.4999, 0.025 / 2);
	cout << "\n----------\n";
	SyL = sy;
	SzL = sz;
	Metodo_EDO_Superior(0, 0.4999, (0.025 / 2) / 2.0);
	cout << "\n----------\n";
	SyLL = sy;
	SzLL = sz;
	cout << "\nCoeficiente de y: ";
